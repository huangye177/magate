...
public class guiAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ch.hefr.gridgroup.magate.gui.StartGUI.class).getContext().getResourceMap(guiAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ch.hefr.gridgroup.magate.gui.StartGUI.class).getContext().getActionMap(guiAboutBox.class, this);
